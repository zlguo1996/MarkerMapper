...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "/usr/local/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PKG_CONFIG_FOUND)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/tmp/pcl-20171224-2946-rz29a9/pcl-pcl-1.8.1")
...
list(APPEND PCL_DEFINITIONS " -msse4.2 -mfpmath=sse ")

set(pcl_all_components  common octree io kdtree search sample_consensus filters 2d geometry features ml segmentation visualization surface registration keypoints tracking recognition stereo apps outofcore people simulation )
